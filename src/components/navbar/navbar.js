      ...
      <div className="z-index nav-collection">
        <div className="w3-top w3-container w3-hide-medium w3-hide-small w3-bar w3-black">
          ...
          ABOUT
            ...
            <Link id="socials" to="/"  className="w3-bar-item w3-button w3-right" > <img alt="instagram logo" src={Instagram} /></Link>
            <Link id = "socials" className="w3-bar-item w3-button w3-right" to="/auth"> <img alt="twitter logo" src={Twitter} /></Link>

            <Link id = "socials" className="w3-bar-item w3-button w3-right" to="/auth"> <img alt="Youtube logo" src={Youtube} /></Link>
